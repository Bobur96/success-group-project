...
export default function StudentsList() {
  const { setStudentId, routeChange } = useContext(UserContext);
  ...
  useEffect(() => {
    fetch("https://online-excel-heroku.herokuapp.com/student/list", {
      ...
      .then((res) => res.json())
      .then((data) => setDate(data.data.data));
  }, [date]);

  const showStudent = (id) => {
    fetch(`https://online-excel-heroku.herokuapp.com/student/get/${id}`)
      .then((res) => res.json())
      .then((date) => setStudentId(date.data.data));
                ...
                <div className="card-body">
                  <span className="row justify-content-between align-items-center">
                    <span className="col-md-4 color--heading">
                      <span className="badge background--tertiary text-white me-2">
                        IMG
                      </span>
                      Fullname
                    </span>

                    <span className="col-5 col-md-4 my-sm-0">
                      <svg
                        className="mb-1 me-1"
                        width="16"
                        height="16"
                    ...
                    <span className="col-7 col-md-2 my-sm-0">
                      <svg
                        className="mb-1 me-1"
                        width="16"
                        height="16"
                    ...
                    <span className="d-none d-md-block col-2 text-center">
                      <svg
                        className="me-1 mb-1"
                        width="16"
                        height="16"
                    ...
                    >
                      <div className="card-body">
                        <span className="row justify-content-between align-items-center">
                          ...
                          <span className="col-5 col-md-4 my-sm-0 color--text">
                            <i className="fa-solid fa-building-columns"></i>{" "}
                            {el.universityName}
                          </span>

                          <span className="col-7 col-md-2 my-sm-0 color--text">
                            {el.academicType}
                          </span>

                          <span className="d-none d-md-block col-2 text-center color--text">
